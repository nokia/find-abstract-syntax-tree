...
project = "fAST - find Abstract Syntax Tree"
doc_title = project
module_name = "fast"
copyright = "2023, Nokia"
author = "Maxime Raynal, Marc-Olivier Buob"
description = "This project aims at inferring regular expressions from positive examples."
category = "Grammar inference"
...
html_theme_options = {
    "icon_links": [
        {
            "name": "GitLab",
            "url": "https://gitlabe2.ext.net.nokia.com/mandrews/hockeytracking",
            "icon": "fab fa-gitlab",
            "type": "fontawesome",
        },
    ],
